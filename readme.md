...
Dainarx-Noisy is an extension of [Dainarx](https://anonymous.4open.science/r/Dainarx-1CEC/readme.md) for Noisy data and is capable of handling hybrid systems with noise.
...
- The "data" & "clean_data" folder stores the traces generated by the code.
- The "automata" & "robust_automata" folder stores automaton data.
